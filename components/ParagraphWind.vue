<template>
    <section class="container mx-auto text-gray-500 roboto font-thin text-lg mt-10 leading-relaxed">
        <h1 class="text-4xl roboto-condensed text-gray-400 mb-3 ">Reconsider the way you view your CMS</h1>
